...
class ItineraryActivity(BaseModel):
    ...
    place_id: Optional[str] = Field(description="Optional MongoDB ObjectId of the place if it matches a known destination place")
    ...
    latitude: Optional[float] = Field(description="GPS latitude for map routing")
    longitude: Optional[float] = Field(description="GPS longitude for map routing")
...
class ItineraryDay(BaseModel):
    ...
    date: Optional[str] = Field(description="The specific date if applicable")
...
class Itinerary(BaseModel):
    ...
    explanations: List[str] = Field(description="Explanations for any required places that could not be reasonably fit into the itinerary.")
